...
//        for (int i = 0; i < 5; i++) {
//            floors.add(MapFactory.generateCellularTileMap());
//            floors.get(0).setVisited(false);
//        }
//
//        currentMap = floors.get(currentFloor);
//        currentMap.setVisited(true);
//        currentMap = MapFactory.createDungeon(60,40);
////        currentMap = MapFactory.createDungeonFromAutomata(60,40);
////        currentMap = MapFactory.createEmptyMap();
////        int randomNumber;
////        for (int i = 0; i < 9; i++) {
////            for (int j = 0; j < 9; j++) {
////                randomNumber = RandomNumber.range(1,4);
////                currentMap.addMapComponent(ImageToPrefab.getMapFromImage("prefabs/tile_0"+randomNumber+".png"), 9*i,9*j);
////
////            }
////        }
...
//
//        ArrayList<GridPoint2> circleBorder = LineOfSight.getLineOfSightCircle(tile.getX(), tile.getY(), radius, currentMap.getTileArray());
